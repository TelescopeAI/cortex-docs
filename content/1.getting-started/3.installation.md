...
The recommended way to install Cortex is using pip:
...
- **Database**: PostgreSQL, MySQL, BigQuery (for data sources)
...
export CORE_DB_TYPE="postgresql+psycopg"    # Database dialect
export CORE_DB_USERNAME="username"          # Database username
export CORE_DB_PASSWORD="password"          # Database password
export CORE_DB_HOST="localhost"             # Database host
export CORE_DB_PORT="5432"                  # Database port
export CORE_DB_NAME="cortex"                # Database name
```

**Supported Database Types:**
- `postgresql+psycopg` - PostgreSQL (recommended)
- `mysql+pymysql` - MySQL
...
```bash
uvicorn cortex.api.main:app --host 0.0.0.0 --port 8000
```
...
- Cortex installed (`pip install telescope-cortex[api]`)
...
```bash
# Set database configuration
export CORE_DB_TYPE="postgresql+psycopg"
export CORE_DB_USERNAME="username"
export CORE_DB_PASSWORD="password"
export CORE_DB_HOST="localhost"
export CORE_DB_PORT="5432"
export CORE_DB_NAME="cortex"
